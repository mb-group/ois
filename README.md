...
```shell
$ python3 utilits/fastaToMatrix.py tutorial/msa.fasta msa.dat
```
...
<p style="text-align:center;"><img src="tutorial/img/likelihood1.png" alt="lkelihood1" width="500"/></p>
...
<p style="text-align:center;"><img src="tutorial/img/likelihood2.png" alt="lkelihood1" width="500"/></p>
